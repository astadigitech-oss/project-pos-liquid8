...
import { listMigrationAtom } from "../_api/queries";
import { column } from "./columns";

export const MigrationsClient = () => {
  const { data: storeSelect, isLoading: isStoreSelectLoading } =
    useAtomValue(listStoreSelectAtom);
  const [storeId, setStoreId] = useAtom(migrationAdminStoreId);
  return (
    <AtomValue atom={listMigrationAtom}>
...
const MigrationSearchInput = ({
  ...
  const [search, setSearch] = useAtom(migrationAdminSearch);
